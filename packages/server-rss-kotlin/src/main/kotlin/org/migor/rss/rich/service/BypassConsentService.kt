...
class BypassConsentService {
  ...
  fun tryBypassConsent(corrId: String, request: BoundRequestBuilder, url: String) {
  ...
  private fun setCookie(corrId: String, request: BoundRequestBuilder, cookies: String) {
    this.log.info("[${corrId}] Setting cookie to bypass consent")
