...
export type FeedlessPluginExecution = GetElementType<GqlSourceSubscriptionByIdQuery['sourceSubscription']['plugins']>['params'];
export type SubscriptionSource = GetElementType<GqlSourceSubscriptionByIdQuery['sourceSubscription']['sources']>;
export type SourceSubscription = GetElementType<GqlCreateSourceSubscriptionsMutation['createSourceSubscriptions']>;
