...
interface PaymentService {
     ...
     */
    suspend fun getPaymentsByOrderId(orderId: UUID): List<PaymentTransaction>

    suspend fun handlePaymentCallback(orderId: UUID)
    suspend fun handlePaymentFailureCallback(orderId: UUID)
    suspend fun handlePaymentCancelCallback(orderId: UUID)
}
