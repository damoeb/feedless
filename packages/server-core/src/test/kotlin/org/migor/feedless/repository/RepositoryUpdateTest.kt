...
class RepositoryUpdateTest {
  ...
  fun setUp() {
    ...
    repositoryService = spy(RepositoryService(
...
//      mock(UserDAO::class.java),
  ...
  fun `given all requirements are met, update will work`() = runTest {
    ...
    `when`(planConstraintsService.coerceMinScheduledNextAt(
