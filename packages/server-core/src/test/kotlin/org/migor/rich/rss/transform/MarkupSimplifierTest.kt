...
internal class MarkupSimplifierTest {
  ...
  fun allowsSemanticTags() {
    val actual = simplifier.simplify(parse("<article><header>title</header><section>lorem ipsum</section> <a href=\"http://google.de\">or</a> <p>that</p><footer>the foot</footer></article>"))
    assertEquals("""<article><header> title </header> <section> lorem ipsum </section> <a href="http://google.de">or</a> <p>that</p> <footer> the foot </footer></article>""", actual)
  }

  @Test
  fun allowsImages() {
    val actual = simplifier.simplify(parse("""
      <div gravityscore="0">
    ...
    """.trimIndent()))
    assertEquals("<article><div> <figure> <picture> <img src=\"https://i.ds.at/c3pwFg/rs:fill:750:0/plain/2021/12/15/ludwig002.jpg\"> </picture> <figcaption> <p>Bürgermeister Michael Ludwig (SPÖ) verteidigte am Mittwoch das Vorgehen der Stadt gegen die Klimaaktivisten.</p> </figcaption> <footer> Foto: APA/HERBERT NEUBAUER </footer> </figure> <img src=\"https://i.ds.at/c3pwFg/rs:fill:750:0/plain/2021/12/15/ludwig002.jpg\"> </div></article>", actual)
  }

  @Test
  fun removesEmptyContainers() {
    val actual = simplifier.simplify(parse("<article><header></header><section>lorem ipsum<em></em></section> or <p>that</p><footer>the foot</footer></article><div><div><div><div><div></div></div></div>"))
    assertEquals("<article><section> lorem ipsum </section> or <p>that</p> <footer> the foot </footer></article>", actual)
  }
