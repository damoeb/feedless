...
//    val user = userService.getSystemUser()
    val user = userService.createUser(corrId, "root", propertyService.rootEmail, propertyService.rootSecretKey, true)
...
//
  private fun getNativeFeedForWebsite(
    ...
    val nativeFeed =
      nativeFeedService.createNativeFeed(corrId, title, "", feed.url, websiteUrl, true, harvestItems, false)
