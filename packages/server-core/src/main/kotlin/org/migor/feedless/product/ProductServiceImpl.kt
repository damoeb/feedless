...
class ProductServiceImpl(
  ...
  override suspend fun findAllByProductId(productId: ProductId): List<PricedProduct> {
    return pricedProductRepository.findAllByProductId(productId)
  }
...
private suspend fun Product.prices(pricedProductRepository: PricedProductRepository): List<PricedProduct> {
