...
import org.migor.feedless.community.DocumentVoteEntity
...
open class AbstractDocumentEntity : EntityWithUUID() {
...
//  open var isControversial: Boolean = false
  ...
  open var votes: MutableList<DocumentVoteEntity> = mutableListOf()
