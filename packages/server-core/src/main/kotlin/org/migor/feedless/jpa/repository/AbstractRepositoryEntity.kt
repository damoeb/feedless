package org.migor.feedless.jpa.repository
...
open class AbstractRepositoryEntity : EntityWithUUID() {
  ...
  open var plugins: List<org.migor.feedless.jpa.repository.PluginExecution> = emptyList()
...
private fun org.migor.feedless.jpa.repository.PluginExecution.toDto(): PluginExecution {
