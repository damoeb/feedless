...
class FeatureService(
  ...
  suspend fun isDisabled(featureName: FeatureName, featureGroupIdOptional: FeatureGroupId? = null): Boolean {
    ...
    return featureValueRepository.resolveByFeatureGroupIdAndName(featureGroupId, featureName.name)?.let { feature ->
      run {
...
//  }
  ...
  private suspend fun createFeature(featureName: FeatureName): Feature {
    val feature = Feature(
