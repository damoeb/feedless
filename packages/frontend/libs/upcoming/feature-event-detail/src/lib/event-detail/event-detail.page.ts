...
import { EventDetailResolverData } from '@feedless/upcoming-data-access';
import { renderEventUrl, renderPlaceUrl } from '@feedless/upcoming-util';
import { LocalizedEvent } from '@feedless/upcoming-data-access';
