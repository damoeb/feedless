...
import { FeatureService, RepositoryService } from '@feedless/data-access';
import {
...
import { BubbleComponent } from '@feedless/ui';
import { FetchRateAccordionComponent } from '@feedless/ui';
import {
  FilterField,
...
export type RepositoryModalAccordion =
  'privacy' | 'storage' | 'notifications' | 'plugins';
  ...
  implements RepositoryModalComponentProps, OnInit
{
  ...
  openFlowModal() {
    return this.modalProvider.openFlowModal(FlowModalComponent, {});
  }
}
