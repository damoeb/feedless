...
fun SourcePipelineJobEntity.toDomain(): SourcePipelineJob {
    return SourcePipelineJobMapper.Companion.INSTANCE.toDomain(this)
}

fun SourcePipelineJob.toEntity(): SourcePipelineJobEntity {
    return SourcePipelineJobMapper.Companion.INSTANCE.toEntity(this.updateStatus(this.status))
}
