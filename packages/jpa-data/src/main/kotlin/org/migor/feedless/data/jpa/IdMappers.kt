...
interface IdMappers {
  ...
  fun map(value: UserId?): UUID? = value?.value
  ...
  fun mapSourceId(value: SourceId?): UUID? = value?.value

  // Document IDs
  fun mapDocumentId(value: UUID?): DocumentId? = value?.let { DocumentId(it) }
  fun mapDocumentId(value: DocumentId?): UUID? = value?.value
  ...
  fun mapConnectedAppId(value: ConnectedAppId?): UUID? = value?.value
  ...
  fun mapGroupId(value: GroupId?): UUID? = value?.value
  ...
  fun mapOrderId(value: OrderId?): UUID? = value?.value
  ...
  fun mapProductId(value: ProductId?): UUID? = value?.value

  fun mapPricedProductId(value: UUID?): PricedProductId? = value?.let { PricedProductId(it) }
  fun mapPricedProductId(value: PricedProductId?): UUID? = value?.value

  // Report IDs
  fun mapReportId(value: UUID?): ReportId? = value?.let { ReportId(it) }
  fun mapReportId(value: ReportId?): UUID? = value?.value
