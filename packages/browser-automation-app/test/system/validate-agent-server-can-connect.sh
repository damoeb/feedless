...
docker run -d --rm --name "$AGENT_CONTAINER_NAME" --cap-add=SYS_ADMIN -p $AGENT_HOST_PORT:3000 -e APP_DISABLE_SOCKET_SUBSCRIPTION=true damoeb/feedless:browser-automation-app-latest > /dev/null
