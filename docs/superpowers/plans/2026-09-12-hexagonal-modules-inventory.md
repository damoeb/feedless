...
FEEDCTL_E2E_CORE_IMAGE=damoeb/feedless:core-$(git rev-parse --short=7 HEAD) ./gradlew :packages:cli:e2eTest   # packages/cli/e2e, go test -tags e2e; agent image defaults to damoeb/feedless:agent-latest (FEEDCTL_E2E_AGENT_IMAGE)
```
