...
- Migrations: `jpa-data/src/main/resources/db/migration/V<n>__<snake_case>.sql`, all applied on start (no `spring.flyway.target`). **Additive only** (AGENTS.md #5) — Flyway checksums what it has applied.
