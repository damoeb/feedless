...
res=[null,singular_key,plural_key];return res[getPluralFormFunc(pluralForms)(val)+1];}
res=val_list[val_idx];if(!res){res=[null,singular_key,plural_key];return res[getPluralFormFunc(pluralForms)(val)+1];}
...
/*
     FILE ARCHIVED ON 01:47:08 Jun 03, 2017 AND RETRIEVED FROM THE
     INTERNET ARCHIVE ON 16:05:47 Feb 23, 2021.
...
playback timings (ms):
  ...
  captures_list: 738.478
  esindex: 0.017
  CDXLines.iter: 53.64 (3)
  PetaboxLoader3.resolve: 192.268 (2)
  LoadShardBlock: 365.797 (3)
  load_resource: 329.834 (2)
  exclusion.robots.policy: 0.32
  PetaboxLoader3.datanode: 225.336 (5)
  RedisCDXSource: 2.612
*/